  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="{{Request::is('/')?'active':''}}"><a href="/"><i class="glyphicon glyphicon-th-list"></i>All Courses</a></li>
        @if (session('student_id'))
        <li class="{{Request::is('my')?'active':''}}"><a href="/my"><i class="glyphicon glyphicon-home"></i>My Courses</a></li>
        @endif
      </ul>
      @if (session('student_id'))
      <div class="dropdown navbar-right">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        <img src="/images/f1.png" class="profile-image img-circle"> {{session('student_name')}}
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="{{URL::action('student_routing_controller@logout')}}">Log out</a></li>
        </ul>
      </div>
      @else
      <a href="{{URL::action('student_routing_controller@loginview')}}" class="dropdown navbar-right" style="line-height:50px;color:white"><span class="glyphicon glyphicon-log-in"> </span> Login</a>
      @endif
